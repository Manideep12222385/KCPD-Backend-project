...
router.post('/new',isAuthenticated, [
    check('firstname').isLength({min: 3}).withMessage('firstname should be more than 3 char'),
    check('lastname').isLength({min: 3}).withMessage('lastname should be more than 3 char'),
    check('email').isLength({min: 3}).withMessage('email should be more than 3 char'),
    check('experience').isLength({min: 3}).withMessage('experience should be more than 3 char'),
    check('postcode').isLength({min: 3}).withMessage('postcode should be more than 3 char')
