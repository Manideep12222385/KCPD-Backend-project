...
router.post('/new',isAuthenticated, [
    check('sub_total').isLength({min: 3}).withMessage('sub total should be more than 3 char'),
    check('vat').isLength({min: 3}).withMessage('alcohol should be more than 3 char'),
    check('total').isLength({min: 3}).withMessage('type should be more than 3 char')
