...
router.post('/new',isAuthenticated, [
    ...
    check('type').isLength({min: 3}).withMessage('type should be more than 3 char'),
    check('category').isLength({min: 3}).withMessage('category should be more than 3 char'),
    check('description').isLength({min: 3}).withMessage('description should be more than 3 char')
...
router.post('/update',isAuthenticated,[
    check('name').isLength({min: 3}).withMessage('name should be more than 3 char'),
    check('price').isLength({min: 3}).withMessage('price should be more than 3 char'),
    check('type').isLength({min: 3}).withMessage('type should be more than 3 char'),
    check('category').isLength({min: 3}).withMessage('category should be more than 3 char'),
    check('description').isLength({min: 3}).withMessage('description should be more than 3 char')
